...
#ifndef _FAST_DDS_GENERATED_WINDSPEED_H_
#define _FAST_DDS_GENERATED_WINDSPEED_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(windSpeed_SOURCE)
#define windSpeed_DllAPI __declspec( dllexport )
#else
#define windSpeed_DllAPI __declspec( dllimport )
#endif // windSpeed_SOURCE
#else
#define windSpeed_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define windSpeed_DllAPI
#endif // _WIN32
...
/*!
 * @brief This class represents the structure windSpeed defined by the user in the IDL file.
 * @ingroup WINDSPEED
 */
class windSpeed
{
public:
     ...
     */
    eProsima_user_DllExport windSpeed();
     ...
     * @param x Reference to the object windSpeed that will be copied.
     */
    eProsima_user_DllExport windSpeed(
            const windSpeed& x);
     ...
     * @param x Reference to the object windSpeed that will be copied.
     */
    eProsima_user_DllExport windSpeed& operator =(
            const windSpeed& x);
     ...
     * @param x windSpeed object to compare.
     */
     ...
     */
    eProsima_user_DllExport void headSpeed(
            float _headSpeed);
...
#endif // _FAST_DDS_GENERATED_WINDSPEED_H_