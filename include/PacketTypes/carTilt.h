...
#ifndef _FAST_DDS_GENERATED_CARTILT_H_
#define _FAST_DDS_GENERATED_CARTILT_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(carTilt_SOURCE)
#define carTilt_DllAPI __declspec( dllexport )
#else
#define carTilt_DllAPI __declspec( dllimport )
#endif // carTilt_SOURCE
#else
#define carTilt_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define carTilt_DllAPI
#endif // _WIN32
...
/*!
 * @brief This class represents the structure CarTilt defined by the user in the IDL file.
 * @ingroup CARTILT
 */
class CarTilt
{
public:
     ...
     */
    eProsima_user_DllExport CarTilt();
     ...
     * @param x Reference to the object CarTilt that will be copied.
     */
    eProsima_user_DllExport CarTilt(
            const CarTilt& x);
     ...
     * @param x Reference to the object CarTilt that will be copied.
     */
    eProsima_user_DllExport CarTilt& operator =(
            const CarTilt& x);
     ...
     * @param x CarTilt object to compare.
     */
...
#endif // _FAST_DDS_GENERATED_CARTILT_H_